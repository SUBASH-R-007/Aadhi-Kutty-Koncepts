  ...
  if (!existing) {
    const context = {
      ...
      brand: {
        ...
        colors: ["#5A277F", "#F4A81D", "#FAF7F2"],
        fonts: ["Arial", "Helvetica"],
        logoRules: ["logo stays in its template safe zone; never redrawn by the image model"],
      },
      aadhi: {
        personality: ["warm", "curious", "encouraging", "sporty"],
        physicalTraits: [
          "anthropomorphic blackbuck",
          "two symmetric ridged spiral horns",
          "warm tan-brown coat with cream muzzle, chest, and brow markings",
        ],
        clothing: [
          "purple varsity letterman jacket with gold trim",
          "gold torch-R college emblem",
          "purple track pants and purple-gold sneakers",
          "sporty purple goggles",
        ],
